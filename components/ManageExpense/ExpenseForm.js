...
function ExpenseForm({ onCancel, onSubmit, submitButtonLabel, defaultValues }) {
  const [inputs, setInputs] = useState({
    amount: {
      ...
      // isValid: defaultValues ? true : false, // option 1
      // isValid: !!defaultValues, // option 2
      isValid: true,
    },
    date: {
  ...
  function inputChangedHandler(inputIdentifier, enteredValue) {
    setInputs((curInputs) => {
      return {
        ...curInputs,
        [inputIdentifier]: { value: enteredValue, isValid: true }, // setting the value of an object key ( this is === amount["value/inputIdentifier"] in python)
      };
    });
  }
